export default class LazyYoutubeEmbedWebp {
    constructor() {
     ...
     let loadThumb = (entries, observer) => {
        ...
        if (connection) {
          ...
          thumbNode.setAttribute('src', `https://i3.ytimg.com/vi_webp/${ytId}/${quality}default.webp`);
          if(quality == "sd"){
            thumbNode.setAttribute('width','640');
            thumbNode.setAttribute('height','480');
          } else if(quality == "hq"){
            thumbNode.setAttribute('width','480');
            thumbNode.setAttribute('height','360');
          } else if(quality == "maxres"){
            thumbNode.setAttribute('width','1280');
            thumbNode.setAttribute('height','720');
          }
          node.innerHTML = '';
